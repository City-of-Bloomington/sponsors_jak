...
public class PaymentSearchServ extends TopServlet{
	...
	out.println("<tr><th><label for=\"id\">Payment ID</label></th>");
	...
	out.println("</td></tr>");
	out.println("<tr><th><label for=\"balance\">Payment has balance</label></th>");
	out.println("<td class=\"left\">");
	if(!hasBalance.equals("")) hasBalance="checked=\"checked\"";
	out.println("<input name=\"hasBalance\" id=\"balance\" type=\"checkbox\" "+hasBalance+
		    " value=\"y\" id/>");
	out.println("</td></tr>");		
	out.println("<tr><th><label for=\"date_from\">Due Date From</label></th>");
	out.println("<td class=\"left\">");
