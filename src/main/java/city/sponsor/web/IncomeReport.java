...
public class IncomeReport extends TopServlet{
	...
	*/
	...
	out.println("<input type=\"radio\" name=\"quarter\" value=\"3\" id=\"q3\"/><label for=\"q3\">Third Quarter</label>");
	out.println("<input type=\"radio\" name=\"quarter\" value=\"4\" id=\"q4\"/><label for=\"q4\">Fourth Quarter</label></td></tr>");
	out.println("<tr><th><input type=\"radio\" name=\"type\" value=\"specific\" id=\"spec\" /><label for=\"spec\">Specific Period</label></th><td>");	
